...
export default class ArrayList extends Module {
    ...
    getAccentColors() {
        ...
        return ['--Ballcrack-accent-color-1', '--Ballcrack-accent-color-2'].map(v => styles.getPropertyValue(v).trim());
    }
    ...
    onEnable() {
        if (!this.initialized) {
            ...
            this.arraylistContainer.style.borderImage = "var(--Ballcrack-accent-color)";
